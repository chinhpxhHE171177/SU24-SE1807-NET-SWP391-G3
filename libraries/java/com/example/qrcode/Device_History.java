...
public class Device_History {
    ...
    public Device_History(int id, String idCode, String code, String name, String issue, String stage, String startTime, String endTime, String totalTime, int recordCount) {
        this.id = id;
        this.idCode = idCode;
        this.code = code;
        this.name = name;
