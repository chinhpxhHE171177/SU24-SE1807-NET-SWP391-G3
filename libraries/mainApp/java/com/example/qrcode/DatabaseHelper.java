...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean insertDevice(Device device) {
        ...
        contentValues.put(Database.DEVICE_LINE, device.getLineName());
    ...
    public void insertListData(String scannedId, String code, String deviceName, String stage, String line, String typeName, String issue,  String startTime, String endTime, String totalTime) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        newContentValues.put(Database.HISTORY_LINE, line);
        newContentValues.put(Database.HISTORY_TYPE_NAME, typeName);
    ...
    public void insertDeviceHistory(String scannedId, String code, String deviceName, String stage, String line, String typeName, String issue, String startTime, String endTime, String totalTime) {
        SQLiteDatabase db = this.getWritableDatabase();
        ...
        if (cursor != null && cursor.moveToFirst()) {
            int errorCountIndex = cursor.getColumnIndex(HISTORY_ERROR_COUNT);
            currentErrorCount = errorCountIndex != -1 ? cursor.getInt(errorCountIndex) + 1 : 1;
            cursor.close();
        } else {
            currentErrorCount = 1;
        }
    ...
    public void insertListData2(String scannedId, String line, String typeName, String startTime, String endTime, String totalTime) {
        SQLiteDatabase db = this.getWritableDatabase();
...
//    public void insertListData(String scannedId, String code, String deviceName, String stage, String typeName, String issue, String startTime, String endTime, String totalTime) {
//        SQLiteDatabase db = this.getWritableDatabase();
//
//        ContentValues values = new ContentValues();
//        values.put("scannedId", scannedId);
//        values.put("code", code);
//        values.put("deviceName", deviceName);
//        values.put("stage", stage);
//        values.put("typeName", typeName); // Make sure typeName is included
//        values.put("issue", issue);
//        values.put("startTime", startTime);
//        values.put("endTime", endTime);
//        values.put("totalTime", totalTime);
//
//        db.insert(DEVICE_HISTORY_TABLE_NAME, null, values);
//        db.close();
//    }
        ...
        if (cursor.moveToFirst()) {
            do {
                try {
                    ...
                    int lineIndex = cursor.getColumnIndexOrThrow(Database.DEVICE_LINE);
        ...
        if (cursor.moveToFirst()) {
            do {
                try {
                    ...
                    int lineIndex = cursor.getColumnIndexOrThrow(Database.HISTORY_LINE);
                    int typeName = cursor.getColumnIndexOrThrow(Database.HISTORY_TYPE_NAME);
