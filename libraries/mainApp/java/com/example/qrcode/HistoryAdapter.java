...
//        holder.txt_Id.setText(String.valueOf(model.getId()));
        holder.txt_Code.setText("Code: " + model.getCode());
        holder.txt_Name.setText("Name: " + model.getName());
        holder.txt_Stage.setText("Stage: " + model.getStage());
        holder.txt_Line.setText("Line: " + model.getLine());
        holder.txt_Issue.setText("Issue: " + model.getIssue());
        holder.txt_StartTime.setText("BD: "  + model.getStartTime());
        holder.txt_EndTime.setText("KT: " + model.getEndTime());
        holder.txt_Duration.setText("Duration: " + model.getTotalTime());
        holder.txt_TypeName.setText("Type: " + model.getTypeName());
    ...
    public static class Holder extends RecyclerView.ViewHolder {
        ...
        private TextView txt_Id, txt_Code, txt_Name, txt_Stage, txt_Line, txt_Issue, txt_ErrorCount, txt_TypeName, txt_StartTime, txt_EndTime, txt_Duration;
