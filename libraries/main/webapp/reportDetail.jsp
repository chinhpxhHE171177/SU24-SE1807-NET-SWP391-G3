...
var longData = [1, 2, 3]; // Dữ liệu cho dừng dài
var shortData = [5, 1, 2]; // Dữ liệu cho dừng ngắn
var shortStopPercentTage = [20, 30, 10]; // Dữ liệu cho tỷ lệ dừng ngắn
                ...
                callbacks: {
                    label: function(tooltipItem) {
                        ...
                        if (tooltipItem.datasetIndex === 4) { 
                            const percentage = 'Tỷ lệ dừng ngắn: ' + tooltipItem.raw + ' %';
