 ...
 // Insert ErrorHistory record into the database
    public void insertErrorHistory(ErrorHistory errorHistory) {
        ...
        try {
            ...
            String sql = "INSERT INTO ErrorHistory (EquipmentID, ErrorDescription, StartTime, EndTime, StageID, TypeID) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            preparedStatement.setInt(6, errorHistory.getTypeId());
