<%-- 
    ...
    Created on : May 30, 2024, 7:20:38 AM
    Author     : Admin
--%>
                    ...
                    <div class="lesson-box">
                        ...
                        <div class="text-center p-4 pb-0">
                            <div class="d-flex justify-content-around">
                                <h5 class="mb-0 text-danger">${lesson.name}</h5>
                                <div class="mb-3">
...
<!--                            <a href="lesson-detail?id=${lesson.id}">-->
                                <!--<h5 style="color: " class="mb-4 mt-3 course-name">${lesson.name}</h5>-->
                            <!--</a>-->
