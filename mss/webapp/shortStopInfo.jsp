    ...
    <c:forEach items="${lists}" var="i" varStatus="loop">
      <tr>
        ...
        <td>
          ...
          <button class="btn" onclick="showEditModelForm('${i.id}', '${i.equipmentId}', '${i.equipmentCode}', '${i.content}', '${i.startDate}', '${i.endDate}', '${i.stageId}')"><i class="fas fa-edit"></i></button>
          <button onclick="doDeleteDevice('${i.id}')"><i class="fas fa-trash"></i></button>
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination">
      <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
        <a class="page-link" href="shortStopInfo?pageIndex=${currentPage - 1}" aria-label="Previous">
          <span aria-hidden="true">&laquo;</span>
        </a>
      </li>
      <c:forEach begin="1" end="${totalPage}" var="i">
        <li class="page-item ${i == currentPage ? 'active' : ''}">
          <a class="page-link" href="shortStopInfo?pageIndex=${i}">${i}</a>
        </li>
      </c:forEach>
      <li class="page-item ${currentPage == totalPage ? 'disabled' : ''}">
        <a class="page-link" href="shortStopInfo?pageIndex=${currentPage + 1}" aria-label="Next">
