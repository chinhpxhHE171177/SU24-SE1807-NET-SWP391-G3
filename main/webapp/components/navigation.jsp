...
<nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary" style="background-color: #c0c0c0;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <!-- Navbar brand -->
            <a class="navbar-brand mt-2 mt-lg-0" href="http://localhost:8080/mssqrcode/" style="font-family: monospace; color: red; font-weight: 600; font-size: 25px;">MSS QRCODE</a>

            <!-- Left links -->
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 menu-nav">
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost:8080/mssqrcode/">Dashboard</a>
                </li>
                <li class="nav-item">
