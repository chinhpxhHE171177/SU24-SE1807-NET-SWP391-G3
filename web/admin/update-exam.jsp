            ...
            <div class="container">
                <div>
                    ...
                    <form action="quiz-manage" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <input type="hidden" id="level" name="level" required value="${QUIZ.level}" class="form-control">
                        </div>
                        <div class="mb-3">
                    ...
                    <a href="quiz-manage?action=viewExam" class="btn btn-link">Back to list</a>
                </div>
            </div>
