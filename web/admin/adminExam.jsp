            ...
            <div class="row no-gutters">
                ...
                <div class="col-10 content">
                    ...
                    <div class="form-inlines mb-3">
                        <form id="searchForm" action="approveExam" method="GET">
                            <input class="form-control mr-2" value="${txtSearch}" type="text" id="search" name="txtSearch" placeholder="Search">
                            <button type="submit">Search</button>
                        </form>
                        <form action="approveExam" method="POST">
                            <select class="form-control mr-2" name="subject">
                                <option value="0" <c:if test="${subjectId == 0}">selected</c:if>>-- All Course --</option>
                                        ...
                                        <td style="display: flex">
                                            <c:choose>
                                                <c:when test="${q.status == true}">
                                                    <a href="approveExam?id=${q.quizID}&action=Inactive" class="btn btn-sm"><i class="far fa-times-circle"></i></a>
                                                    </c:when>
                                                    <c:otherwise>
                                                    <a href="approveExam?id=${q.quizID}&action=Activate" class="btn btn-sm"><i class="fa fa-check-circle" aria-hidden="true"></i></a>
                                                    </c:otherwise>
                                                </c:choose>
                                        </td>
                                    </tr>
