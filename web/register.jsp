    ...
    <body>
        <div class="container">
            ...
            if ("1".equals(error)) {
                ...
                out.println("<p style='color:red; margin:20px;'>Confirm Password Not Match Password</p>");
            }else if ("3".equals(error)) {
                out.println("<p style='color:red; margin:20px;'>Username already exits</p>");
            }
        %>
            <div class="content">
                ...
                Already Account? <a href="login.jsp">Login now</a>
            </div>
            </div>
        </div>
