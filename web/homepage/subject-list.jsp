        ...
        <div class="main">
            <div class="container d-flex col-12">
                <div class="col-3" style="padding-right: 16px">
                    ...
                    <form id="sortBy-form" action="subject-list" method="post">
                        <h3><b>Sort by</b></h3>
                                            ...
                                            <div class="course-item bg-light">
                                                ...
                                                <div class="text-center p-4 pb-0 ">
                                                    <div class="d-flex justify-content-around">
                                                        <h1 style="font-size: 18px" class="mb-0 text-danger">${i.package_name}</h1>
                                                        <div class="mb-3">
                                        ...
                                        <ul class="pagination">
                                            <c:forEach begin="1" end="${totalPage}" var="i">
                                                <li class="page-item ${i == page ? 'active' : ''}">
                                                    <a class="number-of-page" href="subject-list?page=${i}">${i}</a>
                                                </li>
                                            </c:forEach>
                                        </ul>
                                    </div>
