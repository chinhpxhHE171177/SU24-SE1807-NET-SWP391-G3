...
public class UserDAO extends DBContext {
    ...
    public void AddAccount(String username, String password, int roleId, String email, Boolean gender, Date createAt) {
        try {
            String sql = "INSERT INTO Users (UserName, Password, RoleID, Email, Gender, Create_at) VALUES (?, ?, ?, ?, ?, ?);";
    ...
    public static void main(String args[]) {
        ...
        ArrayList<User> users = udao.getAccountFlowingRole(roleToTest);
        ...
        try {
            ...
            String password = "123";
            int roleId = 5;
            String email = "testuser2003@example.com";
            boolean gender = true;
