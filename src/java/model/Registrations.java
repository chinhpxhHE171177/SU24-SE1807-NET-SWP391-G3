...
public class Registrations {
    ...
    public Registrations(int userID, int subjectID, int packageID, Date createdAT) {
        this.userID = userID;
    ...
    public Registrations(int id, int userID, int subjectID, int packageID, BigDecimal totalCost, int status, Date from, Date to, Date createdAT) {
        this.registerID = id;
        this.userID = userID;
        this.subjectID = subjectID;
        this.packageID = packageID;
    ...
    public String toString() {
        return "Registration{" + "id=" + registerID + ", userID=" + userID + ", subjectID=" + subjectID + ", packageID=" + packageID + ", totalCost=" + totalCost + ", status=" + status + ", from=" + validFrom + ", to=" + validTo + ", createdAt=" + createdAT + '}';
    }
